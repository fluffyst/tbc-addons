--[[ $Id: AceComm-3.1.lua 618 2008-03-28 10:35:31Z nevcairiel $ ]]
...
local MAJOR, MINOR = "AceComm-3.1", 4
...
local CTL = assert(ChatThrottleLib, "AceComm-3.1 requires ChatThrottleLib")
