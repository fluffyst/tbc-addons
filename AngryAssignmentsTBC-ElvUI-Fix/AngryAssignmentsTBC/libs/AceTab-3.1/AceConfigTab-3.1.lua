...
-- AceConfigTab-3.1
--
-- Creates an AceTab-3.1 completion set for handling AceConfig-3.1 command trees.
-- ]]

local MAJOR, MINOR = "AceConfigTab-3.1", 1
local lib = LibStub:NewLibrary(MAJOR, MINOR)

if not lib then return end

local ac = LibStub("AceConsole-3.1")
...
--LibStub("AceConfig-3.1"):RegisterOptionsTable("ag_UnitFrames", aUF.Options.table)
local function createWordlist(t, cmdline, pos)
    ...
    opt = LibStub("AceConfigRegistry-3.1"):GetOptionsTable("ag_UnitFrames", "cmd", "AceTab-3.1")  -- hardcoded temporarily for testing
...
LibStub("AceTab-3.1"):RegisterTabCompletion("aguftest", "%/%w+ ", createWordlist, usage)
