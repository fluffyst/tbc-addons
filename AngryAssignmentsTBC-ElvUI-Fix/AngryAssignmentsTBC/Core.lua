local AngryAssign = LibStub("AceAddon-3.1"):NewAddon("AngryAssignments", "AceConsole-3.1", "AceEvent-3.1", "AceComm-3.1", "AceTimer-3.1")
local AceGUI = LibStub("AceGUI-3.1")
local libS = LibStub("AceSerializer-3.1")
...
function AngryAssign:RestoreDefaults()
  ...
  self:UpdateMedia()
  self:UpdateDisplayed()
  LibStub("AceConfigRegistry-3.1"):NotifyChange("AngryAssign")
end
...
function AngryAssign:OnInitialize()
  ...
  local options = {
    ...
    args = {
      ...
      help = {
        ...
        hidden = true,
        func = function()
          LibStub("AceConfigCmd-3.1").HandleCommand(self, "aa", "AngryAssign", "")
        end
      },
      toggle = {
        type = "execute",
  ...
  LibStub("AceConfig-3.1"):RegisterOptionsTable("AngryAssign", options)

  blizOptionsPanel = LibStub("AceConfigDialog-3.1"):AddToBlizOptions("AngryAssign", "Angry Assignments")
...
function AngryAssign:ChatCommand(input)
  ...
  InterfaceOptionsFrame_OpenToFrame(blizOptionsPanel)
    ...
    LibStub("AceConfigCmd-3.1").HandleCommand(self, "aa", "AngryAssign", input)
  end
end
